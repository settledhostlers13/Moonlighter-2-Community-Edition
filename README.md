...
# 🎮 Moonlighter 2: The Endless Vault — Community Edition

**Run the shop by day, raid the vault by night.**
...
Moonlighter 2: The Endless Vault is an action RPG that combines roguelike dungeon exploration with shopkeeping simulation. By day, run Will's store, set prices, and serve customers; by night, delve into shifting chambers of the Endless Vault to gather goods. This Community Edition is a standalone, self-contained package for Windows — no storefront required, no additional software required, ready to play immediately.

Fans of shopkeeping sims and roguelike dungeon crawlers who want a self-contained offline build for Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2350790/ss_bb3f3af6a864f81d459aebcb7c87caef3f0e0c17.1920x1080.jpg?t=1788369976" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2350790/e3522d89fd07d29c450677538392890b5a0cc68d/ss_e3522d89fd07d29c450677538392890b5a0cc68d.1920x1080.jpg?t=1788369976" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2350790/aac8ccda1fa3a7339cc61671192e4db8a9d75e20/ss_aac8ccda1fa3a7339cc61671192e4db8a9d75e20.1920x1080.jpg?t=1788369976" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ✅ **No Steam / Microsoft Store / Xbox app account required**
...
- **Interface:** English, French, German, Spanish (Spain), Japanese, Korean, Polish, Portuguese (Brazil), Russian, Simplified Chinese
- **Voiceover:** English
...
- 🗡️ **Roguelike Dungeon Runs** — Explore procedurally varied chambers of the Endless Vault on every delve.
- 🏪 **Shopkeeping Simulation** — Price loot, manage stock, and grow the shop into a thriving business.
- ⚔️ **Action Combat** — Face vault guardians with melee and ranged weapons, dodges, and combos.
- 🧰 **Crafting and Enchanting** — Turn dungeon spoils into new gear and upgrades for the shop.
- 🎨 **Stylized 3D Visuals** — The sequel reimagines the Moonlighter world with a handcrafted 3D art style.
- 🌍 **Multiple Biomes** — Themed vault regions, each with distinct enemies, hazards, and loot tables.
- 🎮 **Gamepad Support** — Full controller support alongside keyboard and mouse controls.
- 📦 **Self-Contained Package** — Standalone offline version — install and play, nothing else needed.
...
| **Processor** | Intel Core i5-6400 / AMD Ryzen 5 1500X | Intel Core i7-8700 / AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1050 Ti (4 GB) / AMD Radeon RX 570 | NVIDIA GeForce GTX 1660 / AMD Radeon RX 5600 XT |
| **Storage** | 10 GB available space | 12 GB available space (SSD recommended) |
| **Additional** | DirectX 12, keyboard and mouse | DirectX 12, gamepad recommended |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Moonlighter2:TheEndlessVault\Saved`
